...
@foreach ($showfotokegiatan as $kegiatan)
            ...
            <div class="col-lg-8 entries">
              ...
              <article class="entry entry-single" data-aos="fade-up">
                ...
                <div class="entry-content">
                  ...
                  <img src="{{asset('dashboard/fotokegiatan')}}/{{$kegiatan->foto1}}" class="img-fluid" style="margin-bottom: 20px;">
                  <img src="{{asset('dashboard/fotokegiatan')}}/{{$kegiatan->foto2}}" class="img-fluid" style="margin-bottom: 20px;">
                  <img src="{{asset('dashboard/fotokegiatan')}}/{{$kegiatan->foto3}}" class="img-fluid" style="margin-bottom: 20px;">
                  <img src="{{asset('dashboard/fotokegiatan')}}/{{$kegiatan->foto4}}" class="img-fluid" style="margin-bottom: 20px;">
                  <img src="{{asset('dashboard/fotokegiatan')}}/{{$kegiatan->foto5}}" class="img-fluid" style="margin-bottom: 20px;">
