...
.profile-tab p{
    ...
    <div class="container emp-profile">
        <form method="POST" action="{{route('Anggota.organisasi-simpan')}}" enctype="multipart/form-data">
{{ csrf_field() }}
@csrf
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="tab-content profile-tab" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            ...
                                            <div class="row" style="margin-bottom: 10px;">
                                                ...
                                                <div class="col-md-6" >
                                                <input type="text" class="form-control" name="nama_organisasi" placeholder="Nama Organisasi">
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 10px;">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6" >
                                                <input type="text" class="form-control" name="jabatan_organisasi" placeholder="Nama Organisasi">
                                                </div>
                                            </div>
