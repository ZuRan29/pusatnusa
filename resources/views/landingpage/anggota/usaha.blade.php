...
.profile-tab p{
    ...
    <div class="container emp-profile">
        <form method="POST" action="{{route('Anggota.usaha-simpan')}}" enctype="multipart/form-data">
{{ csrf_field() }}
@csrf
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="tab-content profile-tab" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            ...
                                            <div class="row" style="margin-bottom: 10px;">
                                                ...
                                                <div class="col-md-6" >
                                                <input type="text" class="form-control" name="nama_usaha" placeholder="Nama Usaha Anda">
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 10px;">
                                                <div class="col-md-6">
                                            ...
                                            <div class="row" style="margin-bottom: 10px;">
                                                ...
                                                <div class="col-md-6" >
                                                    <textarea class="form-control" name="alamat_usaha" placeholder="Alamat Lengkap Usaha Anda" rows="3" required></textarea>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 10px;">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6" >
                                                <input type="date" class="form-control" name="tahun_berdiri" placeholder="Tahun Berdiri Usaha Anda">
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 10px;">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6" >
                                                    <select select class="custom-select" name="bidang_usaha" required>
                                                        <option>Pilih</option>
                                                        @foreach ($bdus as $bdus)
                                                            <option value="{{$bdus['bidang_usaha']}}">{{$bdus['bidang_usaha']}}</option>
                                                        @endforeach
                                                    </select>
                                                {{-- <input type="text" class="form-control" name="bidang_usaha" placeholder="Bidang Usaha Anda"> --}}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 10px; ">
                                                <div class="col-md-6">
                                                    <label> Detail Bidang Usaha</label>
                                                </div>
                                                <div class="col-md-6" >
                                                <input type="text" class="form-control" name="detailbidang_usaha" placeholder="Detail Bidang Usaha Anda" required>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 10px;">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6" >
                                                    <select select class="custom-select" name="kepemilikan_usaha" id="validationDefault04"  required>
                                                        <option value="">Pilih</option>
                                                        @foreach ($kpm as $kpm)
                                                            <option value="{{$kpm['kepemilikan_usaha']}}">{{$kpm['kepemilikan_usaha']}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 10px;">
                                                ...
                                                <div class="col-md-6" >
                                                    <select select class="custom-select" name="omset_usaha" id="validationDefault04"  required>
                                                        <option value="">Pilih</option>
                                                        @foreach ($omt as $omt)
                                                            <option value="{{$omt['omset_usaha']}}">{{$omt['omset_usaha']}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 10px;">
                                                ...
                                                <div class="col-md-6" >
                                                    <select select class="custom-select" name="karyawan" id="validationDefault04"  required>
                                                        <option value="">Pilih</option>
                                                        @foreach ($krw as $krw)
                                                            <option value="{{$krw['karyawan']}}">{{$krw['karyawan']}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 10px;">
                                                ...
                                                <div class="col-md-6" >
                                                    <select select class="custom-select" name="dana_usaha" id="validationDefault04"  required>
                                                        <option value="">Pilih</option>
                                                        @foreach ($dnu as $dnu)
                                                            <option value="{{$dnu['dana_usaha']}}">{{$dnu['dana_usaha']}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
