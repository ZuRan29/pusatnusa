        ...
        <div class="col-lg-8 entries">
          ...
          <article class="entry entry-single" data-aos="fade-up">
            ...
            <h2 class="entry-title">
              <a href="blog-single.html">{{$sb->judul}}</a>
            </h2>

            <div class="entry-meta">
              <ul>
                <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="blog-single.html">{{$sb->author}}</a></li>
